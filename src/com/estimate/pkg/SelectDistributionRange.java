...
public class SelectDistributionRange extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(DistributionRangeIsub.equals("Uniform")){
				...
				System.out.println("Isub mean:"+IsubMean+"\nIsub SD:"+IsubSD);
		}
		else {
				...
				System.out.println("Isub b:"+Isubb+"\nIsub c:"+Isubc+"\nIsub a:"+Isuba);
		}
		...
		//public void Hot_Carrier_Injection(double IsubMin, double IsubMax, double NMin, double NMax, double  EaaMin, double EaaMax, double TMin, double TMax) throws Exception{
		      ...
		      int rowid=1;
		      double B=1.0;
		      int numberofSim=Integer.parseInt(request.getParameter("numberOfSim"));
		      int scalingFactor=Integer.parseInt(request.getParameter("saclingFactor"));
		      
		      System.out.println("number of sims:"+numberofSim);
		      double[] arr=new double[numberofSim];
		      ...
		      Cell cell_scaled=row1.createCell(0);
		      cell_scaled.setCellValue("TTF_Scaled");
		      ...
		      for(int j=0;j<numberofSim;j++){
		    	  ...
		    	  row1=spreadsheet1.createRow(rowIndex++);
		    	  double ttf_scaled=(arr[j]*scalingFactor)/median;
		    	 
		    	  Cell cell11=row1.createCell(0);
		    	  cell11.setCellValue(ttf_scaled);
